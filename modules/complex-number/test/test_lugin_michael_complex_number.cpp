...
TEST(Lugin_Michael_ComplexNumberTest, Property_Of_The_Imaginary_Unit) {
    // Arrange
...
TEST(Lugin_Michael_ComplexNumberTest, Is_Additive_Inverse_Complex_Number) {
    // Arrange
...
TEST(Lugin_Michael_ComplexNumberTest, Correctness_Of_Operation_Set) {
    // Arrange
    ComplexNumber res;
...
TEST(Lugin_Michael_ComplexNumberTest, Is_Reciprocal_Complex_Number) {
    // Arrange
...
TEST(Lugin_Michael_ComplexNumberTest, Infinity_Not_Reciprocal_Null) {
    // Arrange
